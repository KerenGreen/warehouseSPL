...
bin/warehouse: bin/main.o bin/WareHouse.o bin/Volunteer.o bin/Action.o bin/Customer.o bin/CivilianCustomer.o bin/Order.o bin/SoldierCustomer.o
	@echo 'Building target: warehouse'
	@echo 'Invoking: C++ Linker'
	g++ -o bin/warehouse bin/main.o bin/WareHouse.o bin/Volunteer.o bin/Action.o bin/Customer.o bin/CivilianCustomer.o bin/Order.o bin/SoldierCustomer.o
